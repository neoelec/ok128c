...
#define LCD_DATABUS     (*(volatile uint8_t *)0x2000)   // LCD/GLCD data output address
                                                        // 7-segment LED pattern output address
#define LCD_CONTROL     (*(volatile uint8_t *)0x2100)   // LCD/GLCD control signal output address
#define DIG_SELECT      (*(volatile uint8_t *)0x2200)   // 7-segment LED digit select ouput address
                                                        // 8-bit parallel data output address
